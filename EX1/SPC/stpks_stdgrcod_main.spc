CREATE OR REPLACE PACKAGE  stpks_stdgrcod_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdgrcod_main.spc
  **
...
TYPE ty_stdgrcod IS RECORD (
     v_sttms_stdgrcodh_master     sttm_stdgrcodh_master%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdgrcod_main FOR stpks_stdgrcod_main
/